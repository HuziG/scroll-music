  ...
  <div fixed top-0 left-0 box-border w-full z-30 shadow-md bg-white border-box h-1xl py-3 px-7 flex items-center justify-between>
    ...
    <div flex>
      <n-tooltip placement="bottom">
        <template #trigger>
          <div
            i-mdi:progress-question flex items-center justify-center text-xl text-black
            mr-12 cursor-pointer hover:opacity-60
            @click="emit('showHelp')"
          />
        </template>
        帮助
      ...
      <n-popover :overlap="overlap" placement="bottom-end" trigger="hover">
        <template #trigger>
          <div
            i-mdi-account flex items-center justify-center text-xl text-black mr-3
